...
import { ArrowRight, Video, Calendar, Clock, Star, Users } from "lucide-react";
            ...
            <div className="relative">
              ...
              <div className="relative p-8 bg-gray-900 border border-gray-800 rounded-lg">
                ...
                <div className="aspect-video bg-gray-800 rounded-lg mb-6 overflow-hidden relative">
                  ...
                  <Video className="absolute bottom-4 left-4 w-8 h-8 text-cyan-500" />
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-cyan-500">30 Minutes</div>
                  </div>
