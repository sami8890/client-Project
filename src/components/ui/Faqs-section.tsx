...
const FAQSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "We offer flexible pricing plans starting from $499/month for startups to custom enterprise solutions. Each plan includes our core AI-powered SEO tools, real-time analytics, and dedicated support. Contact us for a personalized quote based on your specific needs.",
      category: "pricing",
    },
    {
      question: "How do you handle technical SEO issues?",
      answer:
        "Our platform automatically scans for 200+ technical SEO issues including site speed, mobile optimization, XML sitemaps, robots.txt configuration, and schema markup. We provide detailed reports and step-by-step fixes for any identified issues.",
      category: "technical",
    },
    {
    ...
    {
      question: "What technical integrations do you support?",
      answer:
        "Our platform integrates with major CMS platforms (WordPress, Shopify, etc.), analytics tools (Google Analytics, Adobe Analytics), and marketing tools (Google Search Console, SEMrush, Ahrefs). We also provide API access for custom integrations.",
      category: "technical",
    },
  ];
