    ...
    const capabilities = [
        {
            ...
            highlight: "Tailored",
            icon: Rocket,
            description: "Personalized growth plans aligned with your unique business goals and market position"
        },
        {
            label: "Modern Tech Stack",
            highlight: "Advanced",
            icon: Code,
            description: "Leveraging cutting-edge tools and AI to maximize your digital presence"
        },
        {
            label: "Data-Driven",
            highlight: "Smart",
            icon: BarChart,
            description: "Real-time analytics and insights to guide strategic decisions"
        },
        {
            label: "Agile Process",
            highlight: "Flexible",
            ...
            <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div className="text-center space-y-6">
                        ...
                        >
                            We bring enterprise-level strategies and tools to emerging businesses,
                            helping you build a strong foundation for sustainable growth.
                        </motion.p>
                    </div>
                         ...
                         border border-gray-800 hover:border-cyan-800 transition-colors duration-200"
                            >
                                <div className="flex items-start justify-between mb-4">
                                    ...
                                    <ArrowUpRight className="w-5 h-5 text-gray-600 group-hover:text-cyan-500 
                                         group-hover:translate-x-1 group-hover:-translate-y-1 
                                         transition-all duration-200" />
                                </div>
                                <h3 className="text-xl font-bold text-cyan-400 mb-1">{item.highlight}</h3>
                                <p className="text-lg font-semibold text-gray-300 mb-2">{item.label}</p>
