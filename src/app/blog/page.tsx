...
// const categories = ['All', 'SEO Tips', 'Content Strategy', 'Technical SEO', 'Local SEO']

// const posts = [
//   {
//     id: '1',
//     title: "10 Proven SEO Strategies for 2025",
//     excerpt: "Discover the latest SEO techniques that are driving results in today's digital landscape.",
//     category: "SEO Tips",
//     readTime: "8 min read",
...
//     excerpt: "Learn how artificial intelligence is revolutionizing the way we create and optimize content.",
...
//     excerpt: "A comprehensive guide to ensuring your website's technical foundation is optimized for search engines.",
...
//     excerpt: "Essential strategies to improve your local search presence and attract more customers.",
//     category: "Local SEO",
//     readTime: "7 min read",
//     image: "/placeholder.svg?height=600&width=800"
//   }
...
//             Stay updated with the latest trends, tips, and strategies in SEO and digital marketing.
//           </p>
//         </div>
...
//           <div className="mb-12">
//             <Link href={`/blog/${filteredPosts[0].id}`} className="group relative rounded-2xl overflow-hidden block">
//               <Image
...
//                   {post.excerpt}
//                 </p>
//                 <span className="flex items-center gap-2 text-cyan-400 group-hover:text-cyan-300
...
//               className="flex-1 px-4 py-3 bg-gray-900 border border-gray-800
//                rounded-lg focus:outline-none focus:border-cyan-500
//                text-white placeholder-gray-500"
//             />
//             <button className="px-6 py-3 bg-cyan-500 hover:bg-cyan-400
