...
import { Clock, ChevronRight, Heart, Bookmark, Search, Filter } from 'lucide-react';
                    ...
                    {filteredPosts
                        ...
                        .map((post) => (
                            <Link href={`/blog/${post.slug}`} key={post.slug}>
                                <Card
                                    className="group hover:shadow-lg transition-all duration-300 overflow-hidden border-border h-full"
                                >
